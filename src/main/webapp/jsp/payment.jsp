                            ...
                            <div class="booking-content">
                                ...
                                <div class="booking-tutor-card">
                                    ...
                                    <div class="summary-row">
                                        ...
                                        <span class="val"
                                            style="font-family:monospace;color:#a29bfe">${course.id}</span>
                                    </div>
                                    ...
                                    <div class="wallet-balance-box">
                                        ...
                                        <c:if test="${insufficient}">
                                            <div class="insufficient-warn">
                                                ...
                                                <strong>
                                                    <fmt:formatNumber value="${course.subject.fee - balance}"
                                                        pattern="#,##0" /> VND
                                                </strong>.
                                        ...
                                        <c:if test="${!insufficient}">
                                            <div style="margin-top:0.5rem;font-size:0.82rem;color:#2ecc71">
                                                ...
                                                <strong>
                                                    <fmt:formatNumber value="${balance - course.subject.fee}"
                                                        pattern="#,##0" /> VND
                                                </strong>
                                            </div>
                                        </c:if>
                                ...
                                <form action="<c:url value='/payment'/>" method="post" class="booking-form"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div
                                            style="padding:0.75rem 1rem;background:rgba(108,99,255,0.06);border:1px solid rgba(108,99,255,0.2);border-radius:10px;display:flex;align-items:center;gap:0.6rem;font-size:0.9rem;">
                                            <i class="fas fa-wallet" style="color:#6c63ff"></i>
                                            Ví Điện Tử TutorHub
                                        </div>
                                    </div>
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <button type="submit" class="btn btn-success btn-block btn-lg" id="payBtn">
                                                ...
                                                <strong>
                                                    (
                                                    <fmt:formatNumber value="${course.subject.fee}" pattern="#,##0" />
                                                    VND)
                                                </strong>
                                            </button>
                                        </c:otherwise>
                                ...
                                <c:when test="${not empty payments}">
                                    <div class="history-section">
                                        <h3>
                                            ...
                                            <span
                                                style="background:rgba(108,99,255,0.12);color:#a29bfe;padding:0.2em 0.7em;border-radius:20px;font-size:0.78rem">${payments.size()}</span>
                                        </h3>
                                            ...
                                            <tbody>
                                                <c:forEach var="p" items="${payments}">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <c:choose>
                                                                <c:when test="${p.paymentMethod == 'wallet'}">Ví Điện Tử
                                                                </c:when>
                                                                <c:when test="${p.paymentMethod == 'bank_transfer'}">
                                                                    Chuyển Khoản</c:when>
                                                                <c:when test="${p.paymentMethod == 'momo'}">MoMo
                                                                </c:when>
                                                        ...
                                                        <td>
                                                            <span
                                                                class="${p.status == 'completed' ? 'badge-ok' : 'badge-type'}">
                                                                <c:choose>
                                                                    <c:when test="${p.status == 'completed'}">Hoàn Thành
                                                                    </c:when>
                                                                    <c:when test="${p.status == 'pending'}">Đang Xử Lý
                                                                    </c:when>
                                                        ...
                                                        <td style="color:#94a3b8;font-size:0.82rem">
                                                            <fmt:formatDate value="${p.paymentDate}"
                                ...
                                <c:otherwise>
                                    <div style="text-align:center;padding:3rem;color:#94a3b8">
                                        <i class="fas fa-receipt"
                                            style="font-size:3rem;opacity:0.25;display:block;margin-bottom:1rem"></i>
